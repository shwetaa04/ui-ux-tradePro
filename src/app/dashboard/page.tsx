    ...
    <motion.div className="relative inline-block">
      <div className="flex items-center space-x-2">
        ...
        <select
          ...
          className="bg-gray-800 text-white px-2 py-1 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setMarketData((prevData) =>
        prevData.map((index) => {
          const { change: randomChange, percentChange: randomPercentChange } = generateRandomChange(index.value);
          const newValue = index.value + randomChange;
          return { ...index, value: newValue, change: randomChange, percentChange: randomPercentChange };
        })
      );
    }, 1000);
        ...
        >
          ...
          <div className="flex items-center space-x-2">
            <span className="text-lg text-white">
              {formatCurrency(index.value, selectedCurrency)}
            </span>
            <motion.span
              key={index.change}
              initial={{ opacity: 0 }}
            ...
            >
              ...
              {formatCurrency(index.change, selectedCurrency)} ({index.percentChange.toFixed(2)}%)
            </motion.span>
          </div>
        </motion.div>
      ))}
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        >
          ...
          {formatCurrency(change, selectedCurrency)} ({percentChange.toFixed(2)}%)
        </motion.span>
      </div>
    </motion.div>
  );
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-4">
                <span className="text-gray-300">
                  ₹{formatCurrency(company.marketCap, selectedCurrency)}
                </span>
                <motion.div
                  animate={{
